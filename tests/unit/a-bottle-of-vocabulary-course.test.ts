...
describe("A bottle of vocabulary course", () => {
  it("validates 30 localized phrases in three lessons with matching mastery stages", () => {
    const importer = path.join(process.cwd(), "database/scripts/import-a-bottle-of-vocabulary.cjs");
    ...
    expect(result).toMatchObject({
      status: "valid",
      course: "a-bottle-of-food-vocabulary",
      words: 30,
      lessons: 3,
      blocks: 3,
