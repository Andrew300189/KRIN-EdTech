...
import { createCmsCourseModule } from "@/modules/cms/services/module-operations.service";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ courseId: string }> }) {
  ...
  try {
    ...
    const courseModule = await createCmsCourseModule(guard.user.id, (await params).courseId, input);
