...
export function LessonBlockRenderer({ block, completed, onToggleComplete, canSaveProgress, previewMode = false, hideExerciseContext = false, hideExerciseTheoryText = false, onAttemptResolved }: { block: LessonBlock; completed: boolean; onToggleComplete: (blockId: string) => void; canSaveProgress: boolean; previewMode?: boolean; hideExerciseContext?: boolean; hideExerciseTheoryText?: boolean; onAttemptResolved?: (result: { isCorrect: boolean }) => void }) {
