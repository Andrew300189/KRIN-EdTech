...
export function LessonBlockRenderer({ block, completed, onToggleComplete, canSaveProgress }: { block: LessonBlock; completed: boolean; onToggleComplete: (blockId: string) => void; canSaveProgress: boolean }) {
