...
type TrainingItem = { id: string; exerciseType: string; payload: { prompt?: string; mode?: string; options?: string[]; tiles?: string[]; separator?: string; direction?: string; pronunciationTarget?: string; britishAudioUrl?: string | null; americanAudioUrl?: string | null }; status: string; order: number };
