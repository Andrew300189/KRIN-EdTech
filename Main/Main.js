...
if (demoSubmit && demoAnswer && demoScore) {
  demoSubmit.addEventListener('click', () => {
    ...
    let score = 60;
    let feedback = 'Nice start! Add more specific examples and a clear goal to improve your score.';
    ...
    if (score >= 85) {
      feedback = 'Excellent! Your answer is clear, specific, and action-oriented.';
    } else if (score >= 70) {
      feedback = 'Great job! You have a solid idea — add one more practical detail to make it stronger.';
    }
